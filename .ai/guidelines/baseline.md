...
`ExampleReader`, and splitting the worst predicate method. It now holds 32 entries covering 57 errors.
...
`Transpiler` scores 1616 against a limit of 80, and `Runtime\Support` 355. Both grow with every rule shape
