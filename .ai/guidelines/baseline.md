...
`ExampleReader`, and splitting the worst predicate method. It now holds 33 entries covering 58 errors.
...
`Transpiler` scores 1817 against a limit of 80, and `Runtime\Support` 409. Both grow with every rule shape
