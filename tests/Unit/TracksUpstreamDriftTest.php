...
final class TracksUpstreamDriftTest extends TestCase
{
    ...
    private function census(): string
    {
        $lines = [
            ...
            'is here only because `composer/xdebug-handler` requires it. A survey emits 15 of spaze\'s 38, and',
            'nothing watches those for drift — adding a corpus package is a decision, so this says where the',
            'line is rather than moving it.',
            '',
