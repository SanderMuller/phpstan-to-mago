...
// GENERATED by phpstan-to-mago from ForwardingHelperRule. Do not edit by hand.
...
final class ForwardingHelperRule implements Plugin, NodeAnalysisHook
{

    public function getDefinition(): PluginDefinition
    {
        return new PluginDefinition(
            identifier: 'transpiled/forwarding-helper-rule',
            name: 'ForwardingHelperRule',
            description: 'Transpiled from PHPStan\'s ForwardingHelperRule.',
        );
    }
