...
final class EveryExpressionRule implements Plugin, NodeAnalysisHook
{
    ...
    {
        return [NodeKind::ClassConstantAccess, NodeKind::StaticPropertyAccess, NodeKind::MethodCall, NodeKind::StaticMethodCall, NodeKind::FunctionCall, NodeKind::PropertyAccess, NodeKind::Binary];
    }
