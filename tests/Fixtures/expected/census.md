...
## symplify/phpstan-rules — 31 of 88 the package registers emit, 57 refuse, 8 it registers nowhere
...
## hihaho/phpstan-rules — 5 of 9 the package registers emit, 4 refuse, 11 it registers nowhere
...
## tomasvotruba/type-coverage — 0 of 10 the package registers emit, 10 refuse, 0 it registers nowhere
...
## tomasvotruba/cognitive-complexity — 0 of 3 the package registers emit, 3 refuse, 0 it registers nowhere
