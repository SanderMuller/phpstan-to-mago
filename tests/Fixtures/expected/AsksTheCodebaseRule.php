...
// GENERATED by phpstan-to-mago from AsksTheCodebaseRule. Do not edit by hand.
...
final class AsksTheCodebaseRule implements Plugin, NodeAnalysisHook
{

    public function getDefinition(): PluginDefinition
    {
        return new PluginDefinition(
            identifier: 'transpiled/asks-the-codebase-rule',
            name: 'AsksTheCodebaseRule',
            description: 'Transpiled from PHPStan\'s AsksTheCodebaseRule.',
        );
    }
    ...
    public function analyze(NodeAnalysisContext $context): void
    {
        ...
        if (!(Support::nameEquals(Support::nthExpression($context, $node, 0), 'helper'))) {
            return;
        }

        if (!(Support::classExists($context, 'Examples\\Helpers\\Behaved'))) {
            return;
        }
