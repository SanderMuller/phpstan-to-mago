 ...
 * follow one pattern and `declares` does not — it prints "Strict declares coverage" where the shape predicts
 * "Declare coverage" — and a wrong summary is not a wrong number, it is no number at all: the regex finds
 * nothing and the run dies naming the real rule instead of the guess.
 */
